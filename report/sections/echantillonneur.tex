...
\'Etant donné que nous n'avons pas de lois explicites pour $\alpha | \mathbf y, \delta$ et $\delta | \mathbf y, \alpha$ nous allons employé l'algorithme \textit{Metropolis-within-Gibbs} \ref{alg:sampler}.
